...
#  define crm_trace(fmt, args...)   do_crm_log_unlikely(LOG_DEBUG, fmt , ##args) // define to crm_debug()
...
#  define crm_log_xml_trace(xml, text)   do_crm_log_xml(LOG_DEBUG,   text, xml) // define to crm_log_xml_debug()
